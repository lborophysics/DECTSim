classdef attenuation_tests < matlab.unittest.TestCase
    methods(Test)
        ...
        function test_water(tc) % Don't forget to convet MeV to KeV
            ...
            % tc.verifyEqual(water(1.25  ), 6.323E-02, "RelTol", 2e-3)
        ...
        function test_blood(tc)
            ...
            % tc.verifyEqual(blood(1.25      ), 6.265E-02 * 1.06, "RelTol", 2e-3)
        ...
        function test_lung_by_z(tc)
            ...
            % tc.verifyEqual(lung(1.25      ), 6.271E-02 * 1.050, "RelTol", 2e-3)
        ...
        function test_muscle_by_z(tc)
            ...
            % tc.verifyEqual(muscle(1.25      ), 6.265E-02 * 1.050, "RelTol", 2e-3)
