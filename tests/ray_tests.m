classdef ray_tests < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_ray_init(tc)
            ...
            tc.assertEqual(r2.energy, 30); % default energy - may change later
        end
        ...
        function test_update_parameters(tc)
            r = ray([0;0;0], [1;0;0], 10);
            r.update_parameters([1;0;0], [0;1;0]);
            ...
            r = ray([0;0;0], [1;0;0], 5);
            r.update_parameters([0;0;1], [0;0;1]);
