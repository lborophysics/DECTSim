classdef gui < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        source_files = {'SourceExample40kvp.mat', 'SourceExample80kvp.mat', 'SourceCTP404_135kvp.mat', 'SourceCTP404_80kvp.mat'}
    ...
    methods (Access = private)
        ...
        function RunButtonPushed(app, event)
            ...
            try
                ...
                csv_sino1 = 'source1_sinogram_' + timestamp + '.csv';
                writematrix(sinogram, csv_sino1);
                if do_fan2para
                ...
                csv_recon1 = 'source1_recon_' + timestamp + '.csv';
                writematrix(recon, csv_recon1);
                ...
                if has_source2
                    ...
                    csv_sino2 = 'source2_sinogram_' + timestamp + '.csv';
                    writematrix(sinogram2, csv_sino2);
                    ...
                    csv_recon2 = 'source2_recon_' + timestamp + '.csv';
                    writematrix(recon, csv_recon2);
        ...
        function ResetMenuSelected(app, ~)
            ...
            %app.Source1DropDown.Items = {'Low Energy (40 kvp)', 'High Energy (80 kvp)', 'CTP404 (135 kvp)', 'CTP404 (80 kvp)'};
            %app.Source1DropDown.ItemsData = {'Low Energy (40 kvp)', 'High Energy (80 kvp)', 'CTP404 (135 kvp)', 'CTP404 (80 kvp)'};
            ...
            %app.Source2DropDown.Items = {'None', 'Low Energy (40 kvp)', 'High Energy (80 kvp)', 'CTP404 (135 kvp)', 'CTP404 (80 kvp)'};
            %app.Source2DropDown.ItemsData = {'None', 'Low Energy (40 kvp)', 'High Energy (80 kvp)', 'CTP404 (135 kvp)', 'CTP404 (80 kvp)'};
